...
namespace ExcelComponent.Excel
{
    ...
    /// </summary>
	public class CellFormat : ICloneable
	{
...
//        private const ushort DEFAULT_LINE_COLOUR_INDEX = 8;
	    ...
	    internal CellFormat(XlsDocument doc)
		{
			_doc = doc;
        ...
        internal CellFormat(XlsDocument doc, Bytes bytes, Font font, string format) : this(doc)
        {
...
//                    _diagonalLineColorIndex = DEFAULT_LINE_COLOUR_INDEX;
        ...
        internal bool Equals(CellFormat that)
		{
		...
		public object Clone()
		{
			CellFormat clone = new CellFormat(_doc);
