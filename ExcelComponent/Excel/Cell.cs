...
namespace ExcelComponent.Excel
{
	...
	public class Cell : IXFTarget
	{
		...
		public object Value
		{
			...
			set
			{
                ...
                else if (value is DateTime)
                {
                    ...
                    throw new Exception(string.Format("values of type {0}", value.GetType().Name));
        ...
        internal CellFormat ExtendedFormat
		{
			get
			{
			    CellFormat xf;
...
/*        /// <summary>
			...
			get
			{
                ...
                switch (Type)
				{
					...
					case CellTypes.Error:
                        throw new Exception(string.Format("CellType {0}", Type));
        ...
        private static Bytes RKIntegerValue(object val, bool div100)
        {
            ...
            if (rk < -536870912 || rk >= 536870912)
                throw new Exception( string.Format("{0}:val must be between -536870912 and 536870911", rk));
        ...
        public void UpdateId(CellFormat fromXF)
        {
            _xfIdx = fromXF.Id;
        }
