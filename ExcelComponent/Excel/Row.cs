...
//		private ushort _cellCount;
		...
		public void AddCell(Cell cell)
		{
			...
			if (cCol < 1 || cCol > 256)
                throw new Exception(string.Format("cell.Col {0} must be between 1 and 256", cCol));
	    ...
	    public Cell GetCell(ushort cellIdx)
		{
			if (cellIdx < 1 || cellIdx > 256)
                throw new Exception(string.Format("cellIdx {0} must be between 1 and 256", cellIdx));
