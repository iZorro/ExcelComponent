...
//			_doc = doc;
		...
		internal Cell Add(ushort cellRow, ushort cellColumn)
		{
			...
			if (cellColumn < 1)
                throw new Exception(  string.Format("{0} cellColumn must be >= 1", cellColumn));
			else if (cellColumn > BIFF8.MaxCols)
                throw new Exception(  string.Format("{0} cellColumn cellColumn must be <= {1}", cellColumn, BIFF8.MaxCols));

            if (cellRow < 1)
                throw new Exception(  string.Format("{0} cellRow must be >= 1", cellColumn));
            else if (cellRow > BIFF8.MaxRows)
                throw new Exception(  string.Format("{0} cellRow cellRow must be <= {1}", cellRow, BIFF8.MaxRows));
        ...
        public Cell Add(int cellRow, int cellColumn, object cellValue, CellFormat xf)
        {
            Util.ValidateUShort(cellRow, "cellRow");
            Util.ValidateUShort(cellColumn, "cellColumn");
        ...
        /// <returns>The newly added Cell with the given Row, Column, Value and Style.</returns>
        [Obsolete]
        public Cell AddValueCellXF(int cellRow, int cellColumn, object cellValue, CellFormat xf)
        {
        ...
        /// <param name="xf">An Xf object describing the style of the cell.</param>
        /// <returns>The newly added Cell with the given Row, Column, Value and Style.</returns>
        public Cell Add(ushort cellRow, ushort cellColumn, object cellValue, CellFormat xf)
        {
        ...
        /// <returns>The newly added Cell with the given Row, Column, Value and Style.</returns>
        [Obsolete]
		public Cell AddValueCellXF(ushort cellRow, ushort cellColumn, object cellValue, CellFormat xf)
		{
            return Add(cellRow, cellColumn, cellValue, xf);
		}
